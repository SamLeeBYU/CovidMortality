...
Furthermore, we assume that COVID-19 mortality rates for all counties in each state are independent of another such that $\eta_{st} \overset{\text{iid}}{\sim} N(0,1)$.
